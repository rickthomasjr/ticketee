...
Scenario: Edit ticket link is shown to a user with permissions
  Given "user@ticketee.com" can view the "TextMate 2" project
...
Scenario: Edit ticket link is not shown to a user without permissions
  Given "user@ticketee.com" can view the "TextMate 2" project
  And I am signed in as "user@ticketee.com"
  When I follow "TextMate 2"
  And I follow "Shiny!"
...
Scenario: Delete ticket link is shown to a user with permissions
  Given "user@ticketee.com" can view the "TextMate 2" project
...
Scenario: Delete ticket link is not shown to a user without permissions
  Given "user@ticketee.com" can view the "TextMate 2" project
  And I am signed in as "user@ticketee.com"
  When I follow "TextMate 2"
  And I follow "Shiny!"
